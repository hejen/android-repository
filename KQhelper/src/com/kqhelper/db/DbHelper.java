...
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//²âÊÔÊý¾Ý
		db.execSQL("insert into CO_WorkList(cWorkid,cWorkType,csid) values(?,?,?)", new String[]{"1","1","AYASVZlbvJNzrPaLoUB6bKpb","3448"});
		db.execSQL("insert into CO_WorkList(cWorkid,cWorkType,csid) values(?,?,?)", new String[]{"2","1","AdIgWDifiRcX8tASMSKYVb1Z","860"});
		db.execSQL("insert into CO_WorkList(cWorkid,cWorkType,csid) values(?,?,?)", new String[]{"3","1","ARgcN0nyTguSGHnYO2ZcJ0hc","680"});
		db.execSQL("insert into CO_WorkList(cWorkid,cWorkType,csid) values(?,?,?)", new String[]{"4","1","ARXRV85sJGOw5eCjMthxuIta","620"});
		db.execSQL("insert into CO_WorkList(cWorkid,cWorkType,csid) values(?,?,?)", new String[]{"5","1","Af_WGcIROJ71bPEuK0x3XA1a","682"});
		...
		db.execSQL("insert into CO_WorkPref(cGUID,cWorkid,cName,cValue) values(?,?,?,?)", new String[]{"4","5","smeltCard","45"});
	}
